...
/**
 *
 * @author telmo Manipulacao de classes em java:
...
public class ConversoesDatas {
    ...
    private void testesComparacao() {
        ...
        data_util_date = new java.util.Date(data_util_depois.getTimeInMillis()
    ...
    private void imprimidata() {

        //criar variavel local com util.calendar
        data_util_calendar = java.util.Calendar.getInstance();
        

        data_util_calendar.set(Calendar.YEAR, 2003);
        data_util_calendar.set(Calendar.MONTH, 7);
        data_util_calendar.set(Calendar.DAY_OF_MONTH, 18);
        data_util_calendar.set(Calendar.HOUR_OF_DAY, 10);
        data_util_calendar.set(Calendar.HOUR, 10);
        data_util_calendar.set(Calendar.MINUTE, 27);
        data_util_calendar.set(Calendar.SECOND, 6);
        data_util_calendar.set(Calendar.MILLISECOND, 5);

      
        
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy HH:mm:ss");

        System.out.println("Data aniversário:" + sdf.format(data_util_calendar.getTime()));
        
        Calendar dt = Calendar.getInstance(new Locale("pt-br"));
        
        SimpleDateFormat sdFormato = new SimpleDateFormat("EEEE");
        SimpleDateFormat sdFormato1 = new SimpleDateFormat(String.valueOf(0));
        
        
        System.out.println(" : " +sdFormato.format(dt.getTimeInMillis()) + " , " +sdFormato1.format(dt.getTime()));
